pipeline{
    ...
    stages {
        ...
        stage('Checkout from Git'){
            steps{
                git branch: 'main', url: 'https://github.com/RAVITEJA12344/amazon-prime-video-kubernetes.git',credentialsId: 'github-creds'
            }
        }
    ...
    always {
        script {
            ...
            emailext (
                ...
                """,
                to: 'mohanarao937@gmail.com',
                from: 'mohanarao937@gmail.com',
                replyTo: 'mohanarao937@gmail.comm',
                mimeType: 'text/html',
